namespace Oas.Infrastructure.Migrations
{
    ...
    public partial class cong : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CarCustomer_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Users", t => t.CarCustomer_Id)
                .Index(t => t.CarCustomer_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CarBookings", "CarCustomer_Id", "dbo.Users");
            ...
            DropForeignKey("dbo.CarAccidents", "CarCustomer_Id", "dbo.Users");
