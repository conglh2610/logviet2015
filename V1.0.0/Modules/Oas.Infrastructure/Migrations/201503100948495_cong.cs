namespace Oas.Infrastructure.Migrations
{
    ...
    public partial class cong : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ResolveDate = c.DateTime(nullable: false),
                        Paid = c.Decimal(nullable: false, precision: 18, scale: 2),
                        AccidentStatus = c.Int(nullable: false),
                        CarCustomerId = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.CarCustomers", t => t.CarCustomerId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CarCustomers", "UserId", "dbo.Users");
            DropForeignKey("dbo.CarBookings", "DriverId", "dbo.Drivers");
            DropForeignKey("dbo.CarBookings", "CarCustomerId", "dbo.CarCustomers");
            ...
            DropForeignKey("dbo.CarAccidents", "CarCustomerId", "dbo.CarCustomers");
            ...
            DropIndex("dbo.CarBookings", new[] { "CarCustomerId" });
            DropIndex("dbo.CarBookings", new[] { "DriverId" });
            DropIndex("dbo.CarAccidents", new[] { "CarCustomerId" });
            DropIndex("dbo.CarCustomers", new[] { "UserId" });
